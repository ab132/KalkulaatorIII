...
public class  StatisticsAdapter extends CursorAdapter{
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        displayStatisticsView(view, context, operation);
    }


    private void displayStatisticsView(View view, Context context, Operation operation) {
        ...
        for (OperationType operationType :
            ...
            TextView textViewOperationId =(TextView) child.findViewById(R.id.operationId);
            TextView textViewDaystamp =(TextView) child.findViewById(R.id.daystamp);

            textViewOperationId.setText(operationType.getOperation());
            textViewDaystamp.setText(operationType.getLifetimeCounter());
